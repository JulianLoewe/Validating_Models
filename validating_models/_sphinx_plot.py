"""
This is matplotlib.sphinxext.plot_directive but figure is saved with bbox_inches='tight', pad_inches=0.2.
    ...
    *output_base*
    ...
    for i, code_piece in enumerate(code_pieces):
        ...
        for j, figman in enumerate(fig_managers):
            ...
            for fmt, dpi in formats:
                try:
                    figman.canvas.figure.savefig(img.filename(
                        fmt), bbox_inches='tight', pad_inches=0.2, dpi=dpi)
                except Exception:
                    raise PlotError(traceback.format_exc())
                img.formats.append(fmt)
